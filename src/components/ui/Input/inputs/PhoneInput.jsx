...
export const PhoneInput = forwardRef(({
    ...
    const handleCountrySelect = (country) => {
        ...
        const formatted = formatPhone(digits, country.pattern);
        if (!isControlled) {
                            ...
                            {searchable && (
                                <div className="p-2 border-b border-gray-200 dark:border-gray-700">
                                    <input
                                        ...
                                        className="w-full px-3 py-1.5 text-sm bg-gray-50 dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500/20"
                                        autoFocus
                                    />
                                </div>
                            )}
